...
const AIDocumentGenerator: React.FC = () => {
  ...
  const generateSupplement = async () => {
    ...
    try {
      ...
      if (isEditMode) {
        ...
        const response = await authTokenService.authenticatedFetch(`/api/documents/${supplementDocumentId}/update-supplement`, {
          method: 'PUT',
          headers: {
        ...
        const response = await authTokenService.authenticatedFetch('/api/documents/create-supplement', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json'
          },
  ...
  const generateAIDocument = async () => {
    ...
    try {
      ...
      if (isManualMode) {
        const response = await authTokenService.authenticatedFetch('/api/documents/create-with-template', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json'
          },
      ...
      const response = await authTokenService.authenticatedFetch('/api/ai-document-generator', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json'
        },

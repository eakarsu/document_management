...
async function extractTextContent(filePath, mimeType) {
  try {
    ...
    // Handle Word, PDF, and other documents with LibreOffice
    ...
    if (supportedByLibreOffice.includes(mimeType)) {
      ...
      try {
        ...
        const tempTxtPath = `/tmp/${tempFileName}.txt`;
...
async function reindexAllDocuments() {
  try {
    console.log('🚀 Starting document reindexing with text extraction...\n');
    ...
    // Test search for "apple" and "visitor"
    console.log('🔍 Testing search functionality...\n');
    
    const testQueries = ['apple', 'visitor', 'Erol', 'financial'];
